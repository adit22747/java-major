...
//	}
	...
	void testGetAllCourse() {
		...
		courseList.add(new Course(14,"Security", "description of Course", "abc.jpeg", 5000, 3, categoryObj, comment, 0, 0, 0, 0, 0));
...
//		System.out.println(categoryObj.getCourses());
	...
	void testUpdateCourse() {
		...
		Course course = new Course("java", "description of Course", "abc.jpeg", 5000, 3, categoryObj, comment, 0, 0, 0, 0, 0);
